                ...
                <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                    ...
                    <div x-data="{ showPassword: false }">
                        ...
                        <div class="relative">
                            <input id="password"
                                ...
                                class="w-full pl-4 pr-11 py-3 bg-gray-50 border {{ $errors->has('password') ? 'border-red-400' : 'border-gray-200' }} rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition" />
                            <button type="button"
                    ...
                    <div x-data="{ showConfirmPassword: false }">
                        ...
                        <div class="relative">
                            <input id="password_confirmation"
                                ...
                                class="w-full pl-4 pr-11 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition" />
                            <button type="button"
                    ...
                    <div class="flex items-start gap-2.5 pt-1">
                        ...
                        <label for="terms" class="text-xs text-gray-500 leading-relaxed">
                            Saya menyetujui
                            <a href="{{ route('terms') }}" target="_blank" class="text-pink-500 font-semibold hover:text-pink-600">Syarat & Ketentuan</a>
                            serta
                            <a href="{{ route('privacy') }}" target="_blank" class="text-pink-500 font-semibold hover:text-pink-600">Kebijakan Privasi</a>
                            Salonkita.
                        </label>
                    </div>
                    @error('terms')
